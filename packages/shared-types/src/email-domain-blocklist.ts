 ...
 *
 * Snapshot from https://github.com/disposable-email-domains/disposable-email-domains
 * commit at fetch time (refresh via scripts/refresh-disposable-blocklist.mjs).
 *
 * Lower-case ASCII domains, sorted, deduped. Used by classifyEmailDomain
 * to flag throwaway addresses before they enter the access-request flow.
 *
