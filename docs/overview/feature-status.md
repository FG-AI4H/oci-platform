...
| OCI-owned public demo dataset with real S3-hosted images                                                | ✅ Live    | PR [#252](https://github.com/FG-AI4H/oci-platform/pull/252) (#251) |
...
| Prediction module: ModelCard + IUS-on-submission                        | ✅ Live    | [#383](https://github.com/FG-AI4H/oci-platform/pull/383) (#260, ADR-0013/0015)                                                        |
| ModelCard lifecycle status + developer / regulatory / bias / PMS fields | ✅ Live    | [#434](https://github.com/FG-AI4H/oci-platform/pull/434) (#432, ADR-0019 D3)                                                          |
| Model Facts Label generator (WHO 2021 Fig. 7)                           | 🚧 Partial | [#442](https://github.com/FG-AI4H/oci-platform/pull/442) (#261) — structured label + Markdown live; HTML/PDF + per-subgroup rows open |
| CHAI Applied Model Card export                                          | 🚧 Phase C | [#433](https://github.com/FG-AI4H/oci-platform/issues/433) (ADR-0019 D2)                                                              |
...
| IntendedUse module + IMDRF risk tier + Model Facts / CEAR + LMM door-openers + BIOCroissant data-protection ext (ADR-0013/0014/0015) | ✅ Live    | PR [#272](https://github.com/FG-AI4H/oci-platform/pull/272)        |
| `/admin/users` — operator UI for Cognito group membership                                                                            | ✅ Live    | PR [#243](https://github.com/FG-AI4H/oci-platform/pull/243) (#241) |
| `/admin/settings` — operator UI for platform parameters                                                                              | ✅ Live    | PR [#244](https://github.com/FG-AI4H/oci-platform/pull/244) (#242) |
| Branded Cognito Managed Login (matches platform style)                                                                               | ✅ Live    | PR [#245](https://github.com/FG-AI4H/oci-platform/pull/245) (#240) |
| Audit-coverage CI grep — emitter call-site discipline (ADR-0014)                                                                     | ✅ Live    | #258                                                               |
...
| Tool-integration contract + registry (RFC 8693, presigned URLs, `metadataBundle`)                                                               | ✅ Live        | PR [#315](https://github.com/FG-AI4H/oci-platform/pull/315) (#214, ADR-0007) + completeness sub-issue [#231](https://github.com/FG-AI4H/oci-platform/issues/231); security boundary follow-up [#314](https://github.com/FG-AI4H/oci-platform/issues/314)                                                                                                                                                                                                                                                                                |
| Workflow engine + 3-gate SOP + sample rejection + output-license declaration                                                                    | 🚧 In flight   | [#215](https://github.com/FG-AI4H/oci-platform/issues/215) — slice 1 (campaign lifecycle) ✅ shipped (PR #246); slice 2 backend (Task + Gate state machine + role-Visa + FIFO routing) ✅ shipped (PR #281); slice 2 web (manager Tasks card + annotator queue) 🚧 in flight; slice 3 (ADR-0009 routing P2–P5 + IRR + STAPLE) planned + sub-issues [#229](https://github.com/FG-AI4H/oci-platform/issues/229) / [#232](https://github.com/FG-AI4H/oci-platform/issues/232) / [#235](https://github.com/FG-AI4H/oci-platform/issues/235) |
| IRR metric library — Cohen's κ + Fleiss' κ + Dice + Krippendorff α (nominal/ordinal/interval) + Hausdorff + ICC + Euclidean + annotator-vs-gold | ✅ Live        | [#216](https://github.com/FG-AI4H/oci-platform/issues/216) (E4) — PRs [#293](https://github.com/FG-AI4H/oci-platform/pull/293) / [#302](https://github.com/FG-AI4H/oci-platform/pull/302) (#289) / [#303](https://github.com/FG-AI4H/oci-platform/pull/303) (#290) / [#297](https://github.com/FG-AI4H/oci-platform/pull/297) (#291); build-chain fix [#304](https://github.com/FG-AI4H/oci-platform/pull/304)                                                                                                                          |
| IRR scoring — STAPLE consensus + intra-rater agreement (remaining E4 scope)                                                                     | 🚧 Planned     | [#216](https://github.com/FG-AI4H/oci-platform/issues/216) (E4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Persistence outputs — DICOM SR (TID-1500/1410/1411) + FHIR R5 + Croissant-RAI                                                                   | ✅ Live        | PR [#317](https://github.com/FG-AI4H/oci-platform/pull/317) (#218, ADR-0008)                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Metadata-exposure + blinding engine (per-task `metadataBundle` filtering, ADR-0010)                                                             | ✅ Live        | PR [#309](https://github.com/FG-AI4H/oci-platform/pull/309) (#308)                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Dataset modality → allowed task kinds (campaign-create UX safety net)                                                                           | ✅ Live        | PR [#253](https://github.com/FG-AI4H/oci-platform/pull/253) (#247)                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Catalog ↔ annotation linkage (FK + manifest-version + new-distribution write-back)                                                              | 🚧 In flight   | [#223](https://github.com/FG-AI4H/oci-platform/issues/223) (E11) — hard FK + manifest-version pin ✅ shipped (PR [#322](https://github.com/FG-AI4H/oci-platform/pull/322), ADR-0016, #320); write-back [#321](https://github.com/FG-AI4H/oci-platform/issues/321) + seed-time `sampleRef` validation [#329](https://github.com/FG-AI4H/oci-platform/issues/329) planned                                                                                                                                                                 |
| Consent management + annotator-agreement signing (reuses DocuSeal AdES #128)                                                                    | 🚧 In flight   | [#224](https://github.com/FG-AI4H/oci-platform/issues/224) (E12) — consent records + revocation + per-dataset audit gate ✅ shipped (PR [#318](https://github.com/FG-AI4H/oci-platform/pull/318), ADR-0012); annotator-agreement signing [#234](https://github.com/FG-AI4H/oci-platform/issues/234) + attribution [#312](https://github.com/FG-AI4H/oci-platform/issues/312) planned                                                                                                                                                    |
| Documentation suite (developers / operators / hosts / governance / **annotators**)                                                              | 🚧 In flight   | [#225](https://github.com/FG-AI4H/oci-platform/issues/225) (E14) — `docs/for-annotators/` audience folder + `docs/for-operators/annotation-instructions-guide.md` ✅ shipped (closes #230 doc-DoD); developer/operator/host/governance pages ongoing.                                                                                                                                                                                                                                                                                   |
...
| Capability                                                            | Status  | Shipped in                                                                                                               |
| --------------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------ |
| GitHub issue templates (feature / follow-up / steering / adr-blocked) | ✅ Live | [#143](https://github.com/FG-AI4H/oci-platform/issues/143) → PR [#145](https://github.com/FG-AI4H/oci-platform/pull/145) |
