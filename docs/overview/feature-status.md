...
Last update: **2026-05-17** (three new architectural commitments derived from convergent reading of 5 WHO publications under [docs/research/](../research/): ADR-0013 Intended-Use Statement + IMDRF risk-tier vocabulary, ADR-0014 evidence audit trail + regulator export, ADR-0015 LMM extensibility door-openers. Door-opener schemas + IntendedUse module shipped today; downstream Phase B/C/D work tracked under #257–#270, steering endorsement in #271).
...
- ✅ **Compliance-evidence primitives (Phase B → Phase C runway)** shipped: Intended-Use Statement schema + IMDRF risk-tier derivation in `@oci/shared-types`, LMM extensibility door-openers (open `EvaluationTaskKindSchema` + `ModelClassSchema` incl. `lmm`/`agent`), BIOCroissant data-protection extensions (consent basis, EHDS data-permit, GDPR lawful-basis, data controller/processor, representativeness statement), `intended-use` NestJS module + `POST /v2/intended-use/derive-risk-tier`. All committed in [ADR-0013](../adr/0013-intended-use-statement-and-risk-tier.md) / [ADR-0014](../adr/0014-evidence-audit-trail-and-regulator-export.md) / [ADR-0015](../adr/0015-lmm-extensibility-door-openers.md).
...
- 🚧 **Phase C (evaluation + prediction)** — Django port not yet started; WHO/IMDRF-aligned regulator-evidence sub-epics filed (Prediction module + ModelCard #260, Model Facts Label #261, Evaluation module #262, Fairness report #263, Risk-tier-gated rigor #264).
- 🚧 **Phase D (reporting)** — not yet started; sub-epics filed (CEAR #265, AI-MDR Bridge #266, PMS dashboard #267, policy-use ledger #268, living-evidence delta #269). LMM red-team tooling deferred to Phase D+ (#270).
...
| Endorse ADR-0013 + ADR-0014 + ADR-0015 (IUS, audit trail, LMM extensibility)     | [#271](https://github.com/FG-AI4H/oci-platform/issues/271) |
...
## Compliance evidence (Phase B → C → D)

Architecture locked in [ADR-0013](../adr/0013-intended-use-statement-and-risk-tier.md), [ADR-0014](../adr/0014-evidence-audit-trail-and-regulator-export.md), [ADR-0015](../adr/0015-lmm-extensibility-door-openers.md) on 2026-05-17 from a convergent reading of five WHO publications under [`docs/research/`](../research/). The Intended-Use Statement attaches to AI submissions (`ModelCard`), never to datasets — see the ADR-0013 amendment for the design rationale.

| Capability                                                                                                | Status                           | Tracked in                                                                                                                                                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------------------- | -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Intended-Use Statement schema + IMDRF risk-tier derivation in `@oci/shared-types` (`IntendedUseStatementSchema`, `deriveRiskTier`) | ✅ Live (proposed ADR)            | [PR #272](https://github.com/FG-AI4H/oci-platform/pull/272) · ADR-0013                                                                                                                                                                                                                                                       |
| LMM extensibility door-openers — open `EvaluationTaskKindSchema` + `ModelClassSchema` incl. `lmm`/`agent`         | ✅ Live (proposed ADR)            | [PR #272](https://github.com/FG-AI4H/oci-platform/pull/272) · ADR-0015                                                                                                                                                                                                                                                       |
| BIOCroissant data-protection extensions — `consentBasis`, `lawfulBasis[]`, `ehdsDataPermitId`, `crossBorderSharingPermitted`, `dataController`/`Processor`, `representativenessStatement` (all optional) | ✅ Live (proposed ADR)            | [PR #272](https://github.com/FG-AI4H/oci-platform/pull/272) · ADR-0013                                                                                                                                                                                                                                                       |
| `intended-use` NestJS module + `POST /v2/intended-use/derive-risk-tier`                                          | ✅ Live (proposed ADR)            | [PR #272](https://github.com/FG-AI4H/oci-platform/pull/272)                                                                                                                                                                                                                                                                  |
| `@oci/audit` package + append-only `AuditEvent` table + Postgres append-only triggers                            | 🚧 Phase B planned                | [#257](https://github.com/FG-AI4H/oci-platform/issues/257)                                                                                                                                                                                                                                                                   |
| Audit-coverage CI grep (modules must emit declared taxonomy)                                                     | 🚧 Phase B planned                | [#258](https://github.com/FG-AI4H/oci-platform/issues/258)                                                                                                                                                                                                                                                                   |
| `GET /v2/audit/export` — COSE-signed regulator bundle                                                            | 🚧 Phase C planned                | [#259](https://github.com/FG-AI4H/oci-platform/issues/259)                                                                                                                                                                                                                                                                   |
| Prediction module + `ModelCard` + IUS attachment at submission                                                   | 🚧 Phase C planned                | [#260](https://github.com/FG-AI4H/oci-platform/issues/260)                                                                                                                                                                                                                                                                   |
| Model Facts Label generator (WHO 2021 Fig. 7)                                                                    | 🚧 Phase C planned                | [#261](https://github.com/FG-AI4H/oci-platform/issues/261)                                                                                                                                                                                                                                                                   |
| Evaluation module skeleton consuming extensible task-kind                                                        | 🚧 Phase C planned                | [#262](https://github.com/FG-AI4H/oci-platform/issues/262)                                                                                                                                                                                                                                                                   |
| Fairness / subgroup report (per-group sens/spec/AUC with CIs)                                                    | 🚧 Phase C planned                | [#263](https://github.com/FG-AI4H/oci-platform/issues/263)                                                                                                                                                                                                                                                                   |
| Risk-tier-gated evidence rigor + external validation typing                                                      | 🚧 Phase C planned                | [#264](https://github.com/FG-AI4H/oci-platform/issues/264)                                                                                                                                                                                                                                                                   |
| CEAR — Clinical Evaluation Assessment Report generator                                                           | 🚧 Phase D planned                | [#265](https://github.com/FG-AI4H/oci-platform/issues/265)                                                                                                                                                                                                                                                                   |
| AI-MDR Bridge Report — maps OCI artefacts to EU MDR Annex II/III clauses                                         | 🚧 Phase D planned                | [#266](https://github.com/FG-AI4H/oci-platform/issues/266)                                                                                                                                                                                                                                                                   |
| Post-Market Surveillance dashboard + drift-event API (EU AI Act Art. 72)                                         | 🚧 Phase D planned                | [#267](https://github.com/FG-AI4H/oci-platform/issues/267)                                                                                                                                                                                                                                                                   |
| Policy-use ledger — cite-as identifier on evaluations                                                            | 🚧 Phase D planned                | [#268](https://github.com/FG-AI4H/oci-platform/issues/268)                                                                                                                                                                                                                                                                   |
| Living-evidence / delta report — versioned re-evaluation                                                         | 🚧 Phase D planned                | [#269](https://github.com/FG-AI4H/oci-platform/issues/269)                                                                                                                                                                                                                                                                   |
| LMM red-team corpus + scorer (hallucination, prompt-injection, drift)                                            | 🔬 Phase D+ deferred              | [#270](https://github.com/FG-AI4H/oci-platform/issues/270)                                                                                                                                                                                                                                                                   |
| Steering endorsement of ADR-0013/14/15                                                                           | 🚧 Steering pending               | [#271](https://github.com/FG-AI4H/oci-platform/issues/271)                                                                                                                                                                                                                                                                   |

The mapping from these artefacts to specific regulatory clauses (EU AI Act, EHDS, EU MDR, GDPR) is in [`docs/for-governance/compliance.md`](../for-governance/compliance.md). The AI-builder-facing flow is in [`docs/for-ai-builders/submitting-a-model.md`](../for-ai-builders/submitting-a-model.md). The LMM strategic stance is in [`docs/for-strategy/lmm-extensibility-stance.md`](../for-strategy/lmm-extensibility-stance.md).
