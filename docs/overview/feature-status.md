...
| Workflow engine + 3-gate SOP + sample rejection + output-license declaration                                               | 🚧 In flight   | [#215](https://github.com/FG-AI4H/oci-platform/issues/215) — slice 1 (campaign lifecycle) ✅ shipped (PR #246); slice 2 (Task + Gate state machine + role-Visa + FIFO routing) 🚧 in flight; slice 3 (ADR-0009 routing P2–P5 + IRR + STAPLE) planned + sub-issues [#229](https://github.com/FG-AI4H/oci-platform/issues/229) / [#232](https://github.com/FG-AI4H/oci-platform/issues/232) / [#235](https://github.com/FG-AI4H/oci-platform/issues/235) |
