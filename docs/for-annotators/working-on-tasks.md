...
You agreed to one of these when you signed the annotator agreement (step 3 of [getting started](./getting-started.md)). Per [ADR-0012](../adr/0012-annotation-rights-licensing-annotator-agreement.md) Decision 3, the manager can only declare a non-commercial license when the source dataset's DUO terms or access tier allow it (this is enforced by the platform — see [#235](https://github.com/FG-AI4H/oci-platform/issues/235)).
