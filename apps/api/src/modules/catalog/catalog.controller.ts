...
export class CatalogController {
  ...
  @ApiOperation({
    ...
    description:
      "Validates the manifest against Croissant 1.1 + RAI + BIOCroissant v0.1 (plus the bio-prov v0.2 obligations of the dataset's access tier when the manifest carries bio:provenanceProfile), mirrors distributions to the database, and bumps the dataset to PUBLISHED.",
  })
  @UseGuards(CognitoJwtGuard, RolesGuard)
  @Roles('host', 'admin')
  publishVersion(
